...
namespace MyApp// Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        {
            //Variables buleana para poder el ciclo con las opciones
            bool salir = false;
            ...
            do
            {
                ...
                Console.WriteLine("3. Opcion 3: Tabla de multiplicar");
                Console.WriteLine("4. Salir");
                Console.WriteLine("**************************************");

                Console.Write("Selecionar una opcion: ");
                ...
                switch (opcion)
                {
                    ...
                    case "2":
                    //Se llama la funcion Randon para que se pueda usar en los numeros secretos aleatorios.
                    Random random = new();
                    //La variable numerosSecretos es igual a un rango del 1 al 11 porque en C# cuenta tam bien el 0
                    int numeroSecreto = random.Next(1, 11);
                    int intentos = 0;
                    int intentoUsuario;

                    Console.WriteLine("\n********Adivina el numero secreto (entre 1 y 11)********");
                    ...
                    while (true)
                    {
                        ...
                        if (int.TryParse(Console.ReadLine(), out intentoUsuario))
                        {
                            ...
                            {
                                    Console.WriteLine("!Felicitaciones! Adivinaste el numero secreto en cual es " + numeroSecreto + " y fue adivinado en " + intentos + " intentos.");
                                    break;
                            }
                            else
                            {
